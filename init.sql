...
-- password = admin
INSERT INTO `blog`.`user` (`uuid`, `email`, `pseudo`, `password_hash`, `id_role`) VALUES
('2efdbca7-9655-4d75-b368-969fdddded96', 'admin@blog.be', 'admin', '$2y$10$cYNElyVHz2UHxnTcwYDG5OHKOhQAMzcyFMDSAUr8kDRNrqsb9EsCW', 2);
